...
--
-- Host: 127.0.0.1
-- Tempo de geração: 07-Fev-2023 às 02:37
...
(1, 1, '2023-02-06 22:14:06'),
(2, 1, '2023-02-06 22:31:24'),
(3, 2, '2023-02-06 22:35:17');
...
--
ALTER TABLE `tb_descricoes_tecnicas`
  ADD CONSTRAINT `tb_descricoes_tecnicas_ibfk_1` FOREIGN KEY (`id_produto`) REFERENCES `tb_produtos` (`id_produtos`);

--
-- Limitadores para a tabela `tb_imagens`
--
ALTER TABLE `tb_imagens`
  ADD CONSTRAINT `tb_imagens_ibfk_1` FOREIGN KEY (`id_produto`) REFERENCES `tb_produtos` (`id_produtos`);
